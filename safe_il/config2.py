...
from safe_il.utils import read_file, merge_dict
...
class ConfigFactory:
    ...
    def __init__(self):
        self.parser = argparse.ArgumentParser(description="Safe Imitation Learning")
        self.add_arguments()
        self.base_dict = dict(
            tag="temp",
            seed=None,
    ...
    def add_arguments(self):
        ...
        self.add_argument("--seed", type=int, help="random seed, default is no seed")
        ...
        self.add_argument("--env", type=str, help="task/environment")
