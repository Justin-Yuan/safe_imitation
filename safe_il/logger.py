...
class FileLogger:
    ...
    References:
        * Michael Zhang's logger https://github.com/michaelrzhang/logger
...
class CSVLogger:
    """Logger for saving periodic stats to as csv file."""
...
class ExperimentLogger:
    ...
    def dump_scalars(self):
        ...
        # sorted keys are important for consistency betwen log steps !!!
        for key, val_list in sorted(self.stats_buffer.items()):
            if len(val_list) == 1:
                ...
                val_str = "{:.3f} +/- {:.3f}".format(val_np.mean(),
                                                     val_np.std())
        ...
        for key, value in zip(keys, values):
            ...
            lines.append("| {}{} | {}{} |".format(key, key_space, value,
                                                  val_space))
        lines.append(dashes)
